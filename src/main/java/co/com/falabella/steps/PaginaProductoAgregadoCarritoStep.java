...
public class PaginaProductoAgregadoCarritoStep {
    ...
    public void ClicVerBolsaCompras (){
        ...
        paginaProductoAgregadoBolsaPageObject.getDriver().findElement(
                paginaProductoAgregadoBolsaPageObject.getBtnBolsaCompra()).click();
